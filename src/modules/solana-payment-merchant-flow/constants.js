...
//  const MERCHANT_WALLET = new PublicKey('G2GQavk1vjDYnKZyufn59FgK1yK3QzhPNmaEUXnHXwVP');
const MERCHANT_WALLET = new PublicKey('EHwtMrGE6V5fH3xUKYcoHzbouUqfgB4jd7MsqfQfHVSn');
